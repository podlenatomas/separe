...
type NavScrollItem = {
  key: "oNas" | "nabidka" | "akce" | "kontakt";
  labelKey: "about" | "menu" | "events" | "contact";
  anchor?: undefined;
};
type NavAnchorItem = {
  key: "rezervace";
...
type NavItem = NavScrollItem | NavAnchorItem;

const NAV_ITEMS: NavItem[] = [
  { key: "oNas", labelKey: "about" },
  { key: "nabidka", labelKey: "menu" },
  { key: "akce", labelKey: "events" },
        ...
        >
          {NAV_ITEMS.map((item) => (
            <button
              ...
              onClick={() =>
                item.anchor
                  ? goAnchor(item.anchor)
                  : go(item.key as keyof typeof nav)
              }
