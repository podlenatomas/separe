                    ...
                    <motion.div className="p-8 md:p-10 lg:p-12 bg-background" {...fade}>
                        <div className="mb-8">
                            <div className="flex items-center gap-2 mb-3">
                                ...
                                <h3 className="text-[10px] font-light uppercase tracking-[0.14em]">{t("addressLabel")}</h3>
                            </div>
                        ...
                        <div className="mb-8">
                            <div className="flex items-center gap-2 mb-3">
                                ...
                                <h3 className="text-[10px] font-light uppercase tracking-[0.14em]">{t("contactLabel")}</h3>
                            </div>
                        ...
                        <div className="mb-8">
                            ...
                            <table className="w-full">
                                <tbody>
                                    <tr>
                                        <td className="py-1 text-sm font-medium pr-8">{t("hoursMoSa")}</td>
                                        <td className="py-1 text-sm font-light text-muted">{t("hoursMoSaTime")}</td>
                                    </tr>
                                    <tr>
                                        <td className="py-1 text-sm font-medium pr-8">{t("hoursSu")}</td>
                                        <td className="py-1 text-sm font-light text-muted">{t("hoursSuTime")}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
